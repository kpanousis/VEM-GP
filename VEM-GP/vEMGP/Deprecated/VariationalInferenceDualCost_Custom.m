function [f, df, varBound, m_ast, invV_ast, Vsm, VVsm, over_m, over_v] = VariationalInferenceDualCost_Custom(lam,VarInfparams)
%
...
% VarInfparams.Q0=kernelAndDerivs(0,VarInfparams.clickTimes,VarInfparams.clickSigns,VarInfparams.hypers);
% VarInfparams.Q0=exp(VarInfparams.hypers(1));
% VarInfparams.A=VarInfparams.hypers(4);
...
[Vsm, VVsm] = smoothedKalmanMatrices_Custom(VarInfparams,CRinvC);
...
%3 July 2015
varBound = varBound - 0.5*(sum(log(VarInfparams.Q))+log(VarInfparams.Q0));
assignin('base','Q',VarInfparams.Q);
